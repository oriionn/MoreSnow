...
![Blue Ice on the center of the Crafting Table surrounded of snow blocks](docs/craft_blue_snow.png)
...
![First item: Blue Snow Block, Second Item: Gunpowder, Third Item: Blue Snow Block, Fourth Item: Gunpowder, Fifth Item: Diamond, Sixth Item: Gunpowder, Seventh Item: Blue Snow Block, Eigth Item: Gun Powder, Ninth Item: Blue Snow Block](docs/craft_blue_snow_golem_core.png)
...
![First block : Blue Snow Block, Second Block: Blue Snow Block, Third Block: Blue Snow Golem Core](docs/spawn_blue_snow_golem.png)
